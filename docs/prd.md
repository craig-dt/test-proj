...
| 2026-09-15 | Craig | 0.6 | Issue #29: Section 10 records the bounded-memory technique for `beacons` pass 2: a 1000-element reservoir sample of Intervals and byte sizes per Tuple, exact at or below 1000 flows, an unbiased estimate above. No acceptance-criteria changes. |
